...
### ℹ️ Since the deprecation of [cloudflared](https://developers.cloudflare.com/changelog/2025-11-11-cloudflared-proxy-dns/) dns-proxy command, Stubby & Cloudflared are now replaced with dnsproxy ℹ️
